...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/elasticsearch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/elasticsearch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add elasticsearch
# for installing globally
pixi global install elasticsearch
```
...
It is possible to list all of the versions of `elasticsearch` available on your platform:
...
```
pixi search elasticsearch --channel conda-forge
```
...
* [@margaretjgu](https://github.com/margaretjgu/)
